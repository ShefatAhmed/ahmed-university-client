...
export const { useGetAllSemestersQuery, useAddAcademicSemesterMutation, useGetAcademicDepartmentsQuery, useAddAcademicDepartmentMutation, useGetAcademicFacultiesQuery } = academicMangementApi